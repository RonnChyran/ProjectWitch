    ...
    public class BattleUnit : MonoBehaviour
    {
        ...
        public void Setup(int id, bool isPlayer, int pos, BattleObj bo, int summonDuration = -1)
        {
            ...
            if (leader == null)
            {
                ...
                leader = (GameObject)Resources.Load("Prefabs/Battle/" + mGame.UnitData[0].BattleLeaderPrefabPath);
            }
            ...
            if (soldierPrefab == null)
            {
                ...
                soldierPrefab = (GameObject)Resources.Load("Prefabs/Battle/" + mGame.UnitData[0].BattleGroupPrefabPath);
            }
